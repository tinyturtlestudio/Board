...
public class RecyclerViewAdapterRSVP extends RecyclerView.Adapter<RecyclerViewAdapterRSVP.ViewHolder> {
    ...
    public RecyclerViewAdapterRSVP(Context mContext, ArrayList<String> mImageNames, ArrayList<String> mImages,
                                   ArrayList<String> mDescription, ArrayList<String> mDistance, ArrayList<DocumentSnapshot> eventsQuery) {
